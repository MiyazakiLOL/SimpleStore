...
class OrderStore {
  ...
  void addOrder(OrderModel order) {
    if (!_loaded) {
      // Nếu load chưa kịp xong, vẫn cho add vào list hiện tại.
      // Khi load xong sẽ merge theo kiểu: orders hiện tại + dữ liệu disk.
    }
  ...
  Future<void> _loadFromDisk() async {
    try {
      ...
      // Merge: ưu tiên các đơn đã có trong memory (vừa tạo mới).
      final current = orders.value;
